...
public class Controlador implements WindowListener, ActionListener, MouseListener
{
	...
	public Controlador(Vista v, Modelo m)
	{
		...
		vista.btnTopTen.addActionListener(this); // Top Ten
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(botonPulsado.equals(vista.btnSalir))
		{
			System.exit(0);
		}
		else if(botonPulsado.equals(vista.btnTopTen)) // Top Ten
		{
		...
		else if(botonPulsado.equals(vista.btnPartidaNueva)) // Partida Nueva
		{
